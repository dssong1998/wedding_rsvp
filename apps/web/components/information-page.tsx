...
import { INFORMATION_FEATURED_ARTICLES, INFORMATION_SECTIONS } from "./article-content";
...
export function InformationPage(): JSX.Element {
  return (
    <ThinkingArticlePage
      ...
      title={
        <>
          <span className="thinking-title-accent">대석과 다인의 결혼식</span> 정보를
          <br />
          확인하실 수 있습니다.
        </>
      }
      ...
      bottomArrowNavigation={{
        left: { href: "/fun?invite=invited%40아빠", label: "즐길거리" },
